...
class BasicScenario(object):
    ...
    def remove_all_actors(self):
        ...
        Remove all actors
        """
        print("All actors: {} - {} - {}".format(self.other_actors[0].id, self.other_actors[0].type_id, self.other_actors[0].attributes))
        for i, _ in enumerate(self.other_actors):
            # print("Removing actor {}".format(self.other_actors[i].id))
            # print("Actor exists: {}".format(CarlaDataProvider.actor_id_exists(self.other_actors[i].id)))
