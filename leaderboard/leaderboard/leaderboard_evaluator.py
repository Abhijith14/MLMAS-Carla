...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        print("Loading agent: {}".format(module_name))
    ...
    def _cleanup(self):
        ...
        print("World: {}".format(self.world))
        print("Ego Vehicles: {}".format(self.ego_vehicles))
    ...
    def _register_statistics(self, config, checkpoint, entry_status, crash_message=""):
        ...
        print("\033[1m> Route statistics registered\033[0m")
...
def main():
    ...
    print("Leaderboard evaluation started")
    print("Agent: {}".format(arguments.agent))

    try:
        leaderboard_evaluator = LeaderboardEvaluator(arguments, statistics_manager)
        leaderboard_evaluator.run(arguments)
        print("Leaderboard evaluation finished")
