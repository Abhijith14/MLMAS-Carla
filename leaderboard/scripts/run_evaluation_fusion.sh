...
export TEAM_AGENT=leaderboard/team_code/TransFuserAgent.py # agent
# export TEAM_AGENT=/home/hilalss/work/LAV/leaderboard/leaderboard/autoagents/human_agent.py
...
export CHECKPOINT_ENDPOINT=results/Fusion_result_longest6.json # results file
...
export RECORD_PATH=/home/hilalss/work/LAV/data/rec
export RESUME=True
